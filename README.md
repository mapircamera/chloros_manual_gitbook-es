...
Chloros está disponible en 4 modos de aplicación:

## Chloros: aplicación GUI de escritorio

\[Recomendado] Ventana independiente con todas las funciones.

## Chloros (navegador): interfaz GUI basada en web

Se ejecuta en su navegador web (Chrome/Edge). Ideal para ordenadores más lentos con menos de 4 GB de VRAM.

## [Chloros CLI: Interfaz de línea de comandos](CLI.md)

Procesamiento por lotes desde la línea de comandos. Perfecto para la automatización, la creación de scripts y los flujos de trabajo avanzados. _CLI requiere una licencia Chloros+ para acceder._
