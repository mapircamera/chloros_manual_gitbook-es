...
Cuando inicie por primera vez Chloros y Chloros (navegador), se iniciará su backend. Una vez que esté listo, aparecerá el icono del menú principal en la parte superior izquierda. <img src=".gitbook/assets/image (1) (1) (1).png" alt="" data-size="line"> .
...
Añada archivos/carpetas y elimine archivos del proyecto. Los archivos duplicados se ignoran. Marque la casilla de la columna de destino para cualquier imagen de destino y el procesamiento solo buscará imágenes marcadas como destinos, lo que acelerará considerablemente el tiempo de procesamiento. Utilice el botón de imagen/metadatos para cambiar entre la vista de la cuadrícula de miniaturas de la imagen seleccionada y una tabla detallada de metadatos.
...
Vea sus imágenes en un mapa 2D interactivo basado en sus coordenadas GPS. Compatible con Google Maps y proveedores de mosaicos ESRI, selecciona automáticamente el mejor servicio para su ubicación. Pase el cursor sobre los marcadores para ver vistas previas en miniatura de las imágenes.

#### <img src=".gitbook/assets/icon_log.JPG" alt="" data-size="line"> Registro de depuración

Revise el registro para obtener impresiones de depuración cuando se produzcan problemas. Copie/descargue el registro y envíelo a [Soporte técnico de MAPIR](https://www.mapir.camera/community/contact) para obtener ayuda.
