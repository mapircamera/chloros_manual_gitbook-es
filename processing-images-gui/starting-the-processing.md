...
* Icono: **Botón Reproducir/Iniciar** <img src="../.gitbook/assets/image (2) (1).png" alt="" data-size="line">
...
* Procesa varias imágenes simultáneamente utilizando una [cadena de procesamiento de 4 subprocesos](../processing-architecture/processing-pipeline.md)
* La [adaptación dinámica de cálculo](../processing-architecture/dynamic-compute-adaptation.md) selecciona automáticamente la estrategia óptima para su hardware
