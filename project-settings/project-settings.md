...
* **Nota**: Es posible que se añadan métodos Debayer adicionales en futuras versiones de Chloros.
...
* **Cuándo ajustar**:
  ...
  * Aumente el valor (por ejemplo, a 60-300 segundos) para acelerar el procesamiento cuando la iluminación es constante y se dispone de imágenes de objetivos de calibración frecuentes.
...
* **Cuándo ajustar**: Establezca este valor en la diferencia horaria de su zona horaria local si sus datos PPK utilizan la hora local en lugar de UTC. Por ejemplo:
